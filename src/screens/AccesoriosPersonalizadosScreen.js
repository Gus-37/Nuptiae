    ...
    <SafeAreaView style={styles.safeArea} edges={['top', 'left', 'right']}>
      ...
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Accesorios personalizados</Text>
          <View style={styles.headerButton} />
        </View>
        {loading ? (
          <View style={styles.loadingContainer}>
            <Text style={styles.helper}>Cargando accesorios...</Text>
          </View>
        ) : proveedores.length === 0 ? (
          <View style={styles.emptyContainer}>
            <Text style={styles.helper}>No hay accesorios personalizados. Verifica Firebase en products/accesorios_personalizados.</Text>
          </View>
        ) : (
          <FlatList
            data={proveedores}
