    ...
    <SafeAreaView style={styles.safeArea} edges={['top', 'left', 'right']}>
      ...
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Catedrales</Text>
          <View style={styles.headerButton} />
        </View>
        {loading ? (
          <View style={styles.loadingContainer}>
            <Text style={styles.helper}>Cargando catedrales...</Text>
          </View>
        ) : proveedores.length === 0 ? (
          <View style={styles.emptyContainer}>
            <Text style={styles.helper}>No hay catedrales registradas. Verifica Firebase en products/catedrales.</Text>
          </View>
        ) : (
          <FlatList
            data={proveedores}
