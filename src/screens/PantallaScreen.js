    ...
    <SafeAreaView style={[styles.safeArea, { backgroundColor: colors.bg }]} edges={["top","left","right"]}>
      ...
      <View style={[styles.container, { backgroundColor: colors.bg }]}>
        ...
        <View style={[styles.header, { borderBottomColor: colors.border }]}>
          ...
          <Text style={[styles.headerTitle, { color: colors.text, fontSize: 18 * fontScale }]}>Pantalla</Text>
          <View style={{ width: 24 }} />
        </View>
        ...
        <ScrollView style={styles.content} contentContainerStyle={{ padding: 20 }}>
          ...
          <View style={styles.section}>
            <View style={[styles.optionRow, { backgroundColor: colors.card }]}>
              <View style={styles.optionLeft}>
                ...
                <Text style={[styles.optionText, { color: colors.text, fontSize: 16 * fontScale }]}>Modo oscuro</Text>
              </View>
              <Switch
                value={darkMode}
          ...
          {/* Tamaño de texto */}
          <View style={styles.section}>
            <Text style={[styles.sectionTitle, { color: colors.text, fontSize: 16 * fontScale }]}>Tamaño de texto</Text>
            {textSizes.map(ts => {
