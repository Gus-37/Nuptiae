...
const translations = {
  es: {
    ...
    shareCode: "Comparte este código con otros miembros",
    shareCodePartner: "Comparte este código con tu pareja",
    creator: "Creador",
    member: "Miembro",
    ...
    recentActivityDesc: "Revisa tu historial",
    languageRegion: "Idioma y Región",
    languageRegionDesc: "Cambia tu idioma",
    displaySettings: "Configuración de Pantalla",
    displaySettingsDesc: "Ajusta tema y tamaño",
  ...
  en: {
    ...
    shareCode: "Share this code with other members",
    shareCodePartner: "Share this code with your partner",
    creator: "Creator",
    member: "Member",
    ...
    recentActivityDesc: "Review your history",
    languageRegion: "Language and Region",
    languageRegionDesc: "Change your language",
    displaySettings: "Display Settings",
    displaySettingsDesc: "Adjust theme and size",
    logout: "Sign Out",
